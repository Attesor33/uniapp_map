	...
	<view class="Riversystem">
		...
		<view class="gaowaBox">
			...
			<!-- 	<view class="uploadBox">
					...
					<view class="title">
						<view>监测井问题填报</view>
						<view @click="addJcInfo(dxsProList,totalBasic)" class="bottombtn" style="margin-bottom: 28rpx;">
...
<script>
	...
	export default {
		...
		methods: {
			//监测井填报新增页面
			// +'&num='+c+'&getProInfo='+JSON.stringify(g)
			addJcInfo(e,v){
				console.log('112233',e)
				uni.navigateTo({
					url: '/pages/groundJcadd/groundJcadd?dxsproList='+JSON.stringify(e)+'&basciInfo='+JSON.stringify(v)
				})
			},
			// 返回上一个页面
			back() {
			...
			addInfo(e,v,c,g){
				...
				console.log(e);
				uni.navigateTo({
					url: '/pages/groundprolist/groundprolist?proObj='+JSON.stringify(e)+'&basciInfo='+JSON.stringify(v)+'&num='+c+'&getProInfo='+JSON.stringify(g)
				})
			},
			openModel(){
			},
			...
			search() {
				...
				// console.log('33333',this.dxsProList)
			}
		}
	}
</script>
